...
- **Required**: `token` (Slack OAuth access token). Obtain and store via m8flow (or your platform's secure config or vault). Tokens are never logged or included in error messages.
