...
- **[STRIPE_CONNECTOR_SETUP.md](docs/STRIPE_CONNECTOR_SETUP.md)** – Setup, command reference, error codes, and workflow integration.
- **[STRIPE_TESTING_GUIDE.md](docs/STRIPE_TESTING_GUIDE.md)** – Beginner guide: create a Stripe account, get test API keys, run unit tests, and test Create Payment Intent manually.
